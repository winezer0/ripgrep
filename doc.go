// Package ripgrep 提供基于 PCRE2 的文件内容搜索 API，并包含与命令行工具相同的
...
// # 文件发现
//
// 目录搜索遵循 github.com/winezer0/gitignore 提供的 Git 风格忽略规则，并支持
// CLI glob、隐藏文件、符号链接、最大深度和内置文件类型过滤。SearchZip 启用后
// 还会搜索受支持的 gzip、bzip2 和 zip 内容。
//
// # 环境要求
//
// 文本匹配后端 github.com/VillanCh/go-pcre2-lite 使用 CGO，因此构建 ripgrep
